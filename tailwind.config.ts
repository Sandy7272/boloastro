...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 20px hsl(var(--gold) / 0.2)',
        'glow': '0 0 40px hsl(var(--gold) / 0.3)',
        'glow-lg': '0 0 60px hsl(var(--gold) / 0.4)',
        'premium': '0 25px 80px hsl(32 70% 35% / 0.2), 0 10px 30px hsl(25 18% 3% / 0.4)',
        'elevated': '0 30px 60px hsl(25 18% 3% / 0.4), 0 15px 25px hsl(25 18% 3% / 0.2)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
